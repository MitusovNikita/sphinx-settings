DROP TABLE IF EXISTS sphinx_test.documents;
...
REPLACE INTO sphinx_test.documents ( id, group_id, group_id2, date_added, title, content ) VALUES
...
DROP TABLE IF EXISTS sphinx_test.tags;
CREATE TABLE sphinx_test.tags
(
...
INSERT INTO sphinx_test.tags VALUES
	(1,1), (1,3), (1,5), (1,7),
	(2,6), (2,4), (2,2),
	(3,15),
	(4,7), (4,40);
